...
* Jeder Service für individuelles Protokoll / Log
...
2. Eine Beispiellösung finden Sie im Ordner `solutions/lesson04-tracing/`. Das Beispiel enthält beide Projekte
